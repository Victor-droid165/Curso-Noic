 ...
 * @brief Problema 1005 - Média 1 - Adaptado por Neilor Tonin, URI  Brasil
 * @version 0.1
 * @date 2022-09-11
...
/*
    ...
    os problemas, não esqueça de imprimir o fim de linha após o resultado, caso contrário, você receberá
    "Presentation Error".
*/
...
int main(){
    ...
    cout << "MEDIA = " << (a*pa + b*pb)/(pa + pb) << endl;
    return 0;
}